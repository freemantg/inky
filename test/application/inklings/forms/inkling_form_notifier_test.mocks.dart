...
// in inky/test/application/inklings/forms/inkling_form_notifier_test.dart.
...
/// A class which mocks [InklingImageRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockInklingImageRepository extends _i1.Mock
    implements _i3.InklingImageRepository {
  MockInklingImageRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<String?> pickImage({bool? isCameraSource = false}) =>
      (super.noSuchMethod(
        Invocation.method(
          #pickImage,
          [],
